...
-- tobaccoseed
RSGCore.Functions.CreateUseableItem("tobaccoseed", function(source)
    local src = source
...
RSGCore.Functions.CreateCallback('rsg-farmer:server:CheckCollectedPoop', function(source, cb, coords)
    local exists = false
